...
<div class="three_col">
	...
	<div class="col">
		...
		<ul>
			...
			<li><a href="https://goldplugins.com/documentation/easy-testimonials-documentation/easy-testimonials-installation-and-usage-instructions/submit-a-testimonial-form/<?php echo $utm_str; ?>">Create a Submit Your Testimonial Form</a></li>
