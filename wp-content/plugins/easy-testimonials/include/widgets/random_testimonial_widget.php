		...
		<div class="gp_widget_form_wrapper">
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed_radio">
					...
					<p>
						<input type="hidden" value="0" name="<?php echo $this->get_field_name('reveal_full_content'); ?>" />
						...
						<label for="<?php echo $this->get_field_id('reveal_full_content'); ?>">Click To Reveal Full Text</label>
					</p>	
