		...
		<div class="gp_widget_form_wrapper">
			...
			<fieldset class="radio_text_input">
				...
				<div class="bikeshed_radio">
					...
					<p>
						<input name="<?php echo $this->get_field_name('reveal_full_content'); ?>" type="hidden" value="0" />
						<input class="widefat" id="<?php echo $this->get_field_id('reveal_full_content'); ?>" name="<?php echo $this->get_field_name('reveal_full_content'); ?>" type="checkbox" value="1" <?php if($reveal_full_content){ ?>checked="CHECKED"<?php } ?> data-shortcode-value-if-unchecked="0" />
						<label for="<?php echo $this->get_field_id('reveal_full_content'); ?>">Click To Reveal Text</label>
					</p>	
					...
					<legend>Show Rating:</legend> &nbsp;
						<div class="bikeshed bikeshed_radio">
							<div class="radio_wrapper">
								...
								<p class="radio_option"><label><input class="tog" name="<?php echo $this->get_field_name('show_rating'); ?>" type="radio" value="none" <?php if($show_rating=='none'){ ?>checked="checked"<?php } ?> > Do Not Show</label></p>
							</div>
						</div>						
						<br />
