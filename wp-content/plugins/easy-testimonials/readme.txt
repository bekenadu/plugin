...
Updated for WordPress 5 and Gutenberg! Easy Testimonials now includes 5 custom Gutenberg blocks and works seamlessly with the new Gutenberg editor.
...
With over 25 professionally designed themes included for free, Easy Testimonials is simply the best looking Testimonials plugin for WordPress available. But its not just a great looking plugin - Easy Testimonials is packed with powerful features and has a proven track record of reliability. 

You'll be in good company - Easy Testimonials powers thousands of active websites and has been actively developed for over five years.

Built by a team of developers with years of experience, Easy Testimonials is easy to use for beginners yet highly customizable for professionals. Beginners will be up and running in minutes, while experienced users and developers will find all the options, filters, templates, and display methods they need.  With all the customization options available, customizing Easy Testimonials to fit any theme is a breeze.

= Easy Testimonials is a great plugin for: =
* Adding Testimonials to your current website
* Adding a Testimonials feature to any WordPress theme
* Managing your Testimonials with an easy-to-use interface that requires no new knowledge!
* Showing a Random Testimonial in your Sidebar on every page load
* Adding a Random Testimonial on any Page or Post
* Outputting a list of your Testimonials
* Outputting a list of recent Testimonials
* Outputting a Fading Testimonial Widget
* Outputting a Sliding Testimonial Widget (a.k.a., a Testimonial Slideshow)
* Displaying Responsive Testimonials for multiple screen sizes!
* Displaying a Testimonial with a Rating
* Displaying Testimonials using Schema.org compliant markup (JSON-LD)
...
* Even more themes - Easy Testimonials Pro includes over 100 new themes for Easy Testimonials
* Collect Testimonials: The Front-End Testimonial Form allows your customers to submit Testimonials directly on your website!
* Form Builder: Customize your Testimonial Form with as many fields as you like!
* Multiple Testimonial Forms: use our Testimonial Form Builder to create multiple, custom collection forms!
* Spam Prevention: Supports Google's ReCaptcha and the Really Simple Captcha plugin
...
* More transitions for your Slideshow: including scrolling, flipping, and tiling testimonials!
...
= Simple To Use, but Deeply Customizable =
...
Easily display your testimonials using our 5 new blocks developed for the Gutenberg experience.  No more messing with complicated shortcodes!
...
== Screenshots ==
1. Classic Theme - Light Grey
2. Classic Theme - Blue
3. Classic Theme - Dark Grey
4. Classic Theme - Red
5. Classic Theme - Gold
6. Accolades Theme - Black
7. Accolades Theme - Blue
8. Accolades Theme - Green
9. Accolades Theme - Grey
10. Accolades Theme - Red
11. Compliments Theme - Blue
12. Compliments Theme - Dark Grey
13. Compliments Theme - Green
14. Compliments Theme - Light Grey
15. Compliments Theme - Red
16. Merit Theme - Gold
17. Merit Theme - Green
18. Merit Theme - Grey
19. Merit Theme - Purple
20. Merit Theme - Red
21. Ribbon Theme - Green
22. Ribbon Theme - Blue
23. Ribbon Theme - Gold
24. Ribbon Theme - Greay
25. Ribbon Theme - Teal
26. This is the Add New Testimonial Page.
27. This is the List of Testimonials - from here you can Edit or Delete a Testimonial.
28. This is the Basic Settings Page.
29. This is the Display Options Settings Page.
30. This is the Themes Selection Page.
31. This is the Shortcode Generator.
32. This is the Help & Instructions Page.
33. This is the Random Testimonial Widget.
34. This is the Testimonial Cycle Widget.
35. This is the Testimonial List Widget.
36. This is the Single Testimonial Widget.
37. This is the Testimonial Grid Widget.

== Changelog ==

= 3.8 =
* Style fixes for Testimonial themes.
* Compatible with WordPress 5.7.2.

= 3.7.2 =
* Bug fix: Better handling for when post_type is not set in the loop.

= 3.7.1 =
* jQuery compatibility update for WordPress 5.5.
...
* Fix issue with notices generated from recent PHP versions
* Fix issue with parts of the Classic Style theme background being transparent
* Fix issue with Testimonials Settings Tabs leading to pages with Permissions Errors
* Address 'media_buttons_context' deprecated notices
* Fix issue with Classic Style theme not obeying Ratings Settings
* Fix issue with Shortcode Generator page not working
...
= 3.5 =
* Minor fixes and updates.
* Adds 25 themes (5 styles in 5 colors)!
* Adds demo testimonial content.
...
= 3.4 =
* Adds Expandable / Collapsible Testimonials
* Minor fixes.
* Compatible with Wordpress 5.2

= 3.3.2 =
* Minor fixes.
* Compatibility with new Testimonial Form Builder.

= 3.3.1 =
* Minor fixes.

= 3.3 =
* Adds Gutenberg blocks for Single Testimonials, List of Testimonials, Testimonials Slideshow, Testimonials Grid, and Random Testimonial.
...
**3.8** Style fixes for Testimonial themes. Compatible with WordPress 5.7.2.